...
<html lang="en" dir="ltr">
  ...
  ?>
    ...
    <p>Beginning on January 15, you will be able to drop off your donations in
      ...
      <a href="mailto:aka.vanderbilt@gmail.com?subject=HeartbreAKA%20Inquiry%20about%20Dropbox%20Donations">email</a>.</p><br>

    <form action="donations-dropbox.php" method="post" name="dropbox">
      <label for="full_name">Full Name</label><br>
      <input type="text" name="full_name" value="<?php echo $login_result['fullName']; ?>" readonly required><br><br>
